    ...
    for i in range(start_sentence_idx, len(sentences)):
        ...
        try:
            ...
            response = model.generate_content(
                ...
                in education.
                Double negation: This study did not withhold a content analysis of studies aiming to
                disclose how artificial intelligence (AI) has been applied to the education
                sector and explore the potential research trends and challenges of AI
                in education.
                Original: {\\sentence}
...
def main() -> None:
    ...
    try:
        previous_df = pd.read_csv("double_negation_sentences.csv")
    ...
    df.to_csv("double_negation_sentences.csv", index = False)
